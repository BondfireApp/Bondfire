...
export function isEditableTextMime(mime, name = "") {
  ...
  return [".md", ".markdown", ".txt", ".json", ".js", ".jsx", ".ts", ".tsx", ".css", ".html", ".xml", ".yaml", ".yml", ".csv", ".bfsheet", ".bfform", ".drawio"].some((ext) => safeName.endsWith(ext)) || safeMime === "application/vnd.bondfire.sheet+json" || safeMime === "application/vnd.bondfire.form+json" || safeMime === "application/vnd.jgraph.mxfile" || safeMime === "application/vnd.bondfire.zk-file";
}
