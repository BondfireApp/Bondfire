...
{"id": "treasury", "title": "Treasury", "blurb": "Create funds using your own names and record financial activity. Transfers debit one fund and credit another in the same currency. Unpaid reimbursements, drafts, voids and transactions awaiting required approval do not affect balances. Use Public transparency to select fields, preview and explicitly publish a snapshot; it is off by default.", "keywords": ["treasury"], "sections": [{"h": "Working with Treasury", "p": ["Create funds using your own names and record financial activity. Transfers debit one fund and credit another in the same currency. Unpaid reimbursements, drafts, voids and transactions awaiting required approval do not affect balances. Use Public transparency to select fields, preview and explicitly publish a snapshot; it is off by default.", "Organization roles and record restrictions both apply. Changes are encrypted before saving. Refresh to see updates from other members."]}]},
  {
    "id": "demo-mode",
    "title": "Demo Mode",
