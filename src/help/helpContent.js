...
export function guessTopicIdFromPath(pathname) {
  ...
  for (const topic of ["tasks", "working-groups", "decisions", "cases", "treasury"]) if (p.split("/").includes(topic)) return topic;
...
{"id": "tasks", "title": "Tasks", "blurb": "Create a task, set a due date and add checklist items. Assignments are managed separately according to your role. Complete a recurring task to create its next occurrence. Use My assignments, Due within 7 days and Overdue to focus the list.", "keywords": ["tasks"], "sections": [{"h": "Working with Tasks", "p": ["Create a task, set a due date and add checklist items. Assignments are managed separately according to your role. Complete a recurring task to create its next occurrence. Use My assignments, Due within 7 days and Overdue to focus the list.", "Organization roles and record restrictions both apply. Changes are encrypted before saving. Refresh to see updates from other members."]}]},
{"id": "working-groups", "title": "Working Groups", "blurb": "Working Groups are subgroups within this organization. Add members and coordinators, link documents and create related work. Restrict visibility to selected Bondfire members when needed. Linked workflow records inherit restrictions; Drive documents retain their own sharing rules.", "keywords": ["working-groups"], "sections": [{"h": "Working with Working Groups", "p": ["Working Groups are subgroups within this organization. Add members and coordinators, link documents and create related work. Restrict visibility to selected Bondfire members when needed. Linked workflow records inherit restrictions; Drive documents retain their own sharing rules.", "Organization roles and record restrictions both apply. Changes are encrypted before saving. Refresh to see updates from other members."]}]},
{"id": "decisions", "title": "Decisions", "blurb": "Record a proposal and the decision method your group chose. Save the status, decided date and outcome separately. An adopted decision can create implementation Tasks, and the detail page shows their progress. Search the register and record supersession or a review date as decisions change.", "keywords": ["decisions"], "sections": [{"h": "Working with Decisions", "p": ["Record a proposal and the decision method your group chose. Save the status, decided date and outcome separately. An adopted decision can create implementation Tasks, and the detail page shows their progress. Search the register and record supersession or a review date as decisions change.", "Organization roles and record restrictions both apply. Changes are encrypted before saving. Refresh to see updates from other members."]}]},
{"id": "cases", "title": "Cases", "blurb": "Use Public Inbox to review a submission first. Promote to Case only when it needs ongoing work. Promotion preserves the original and initially restricts the Case to you; manage access to involve other organizers. Public submitters never receive internal access. Record internal notes and external communications separately.", "keywords": ["cases"], "sections": [{"h": "Working with Cases", "p": ["Use Public Inbox to review a submission first. Promote to Case only when it needs ongoing work. Promotion preserves the original and initially restricts the Case to you; manage access to involve other organizers. Public submitters never receive internal access. Record internal notes and external communications separately.", "Organization roles and record restrictions both apply. Changes are encrypted before saving. Refresh to see updates from other members."]}]},
{"id": "treasury", "title": "Treasury", "blurb": "Create funds using your own names and record financial activity. Transfers debit one fund and credit another in the same currency. Unpaid reimbursements, drafts, voids and transactions awaiting required approval do not affect balances. Public transparency is an organization-wide on/off setting, off by default. When on, every transaction’s public name, date, amount and running balance appear automatically with a balance graph on the Organization Page. Personal details, private notes and attachments stay private. Archiving does not hide entries; corrections and voids remain visible.", "keywords": ["treasury"], "sections": [{"h": "Working with Treasury", "p": ["Create funds using your own names and record financial activity. Transfers debit one fund and credit another in the same currency. Unpaid reimbursements, drafts, voids and transactions awaiting required approval do not affect balances. Public transparency is an organization-wide on/off setting, off by default. When on, every transaction’s public name, date, amount and running balance appear automatically with a balance graph on the Organization Page. Personal details, private notes and attachments stay private. Archiving does not hide entries; corrections and voids remain visible.", "Organization roles and record restrictions both apply. Changes are encrypted before saving. Refresh to see updates from other members."]}]},
  {
    "id": "demo-mode",
    "title": "Demo Mode",
