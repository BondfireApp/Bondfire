...
const checks = [
  ...
  ["Colophon post-list controls keep dark-mode contrast", "src/modules/colophon/colophon-native.css", /wp-list-controls[\s\S]*#0f1316[\s\S]*wp-view-tab\.is-active/],
  ["Colophon hides trashed posts from All and permanently empties server trash", "src/modules/colophon/ColophonNativeModule.jsx", /NativePostsTrashBridge[\s\S]*bfPostsTab[\s\S]*status=trash[\s\S]*method: "DELETE"/],
